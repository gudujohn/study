...
<head>
  ...
  <link rel="stylesheet" href="/plugins/layui/css/layui.css">F
...
<body>
  ...
  <div class="main-newsdate">
    <div class="layui-container">
      <p class="news"><a href="/com2/news">实时新闻</a> > 新闻详情</p>
      ...
      <div><img src="/project-com2/img/news_big.jpg" alt="新闻详情图"></div>
