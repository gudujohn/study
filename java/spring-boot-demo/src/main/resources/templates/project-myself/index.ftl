...
<html lang="en">
    <head>
        ...
        <link href="${base}/plugins/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet">
        <link href="${base}/plugins/fonts/font-awesome.min.css" rel="stylesheet">
        ...
        <link href="${base}/project-myself/css/main.css" rel="stylesheet">
        <link rel="icon" href="${base}/project-myself/images/logo.png">
    ...
    <body>
            ...
            <div class="container main">
                <div class="row home">
                    <div id = "index_left" class="col-md-6 left">
                        <img class="img-responsive img-rabbit" src="${base}/project-myself/images/home.jpg">
                    </div>
                    <div id = "index_right" class="col-md-6 text-center right">
                        <div class="logo">
                            <img src="${base}/project-myself/images/logo.png">
                            <h4>I am rabbit</h4>
                        </div>
            ...
            <div class="container main">
                <div class="row">
                    <div class="col-md-6 left" id="about_left">
                        <img class="img-responsive img-rabbit" src="${base}/project-myself/images/about.jpg">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6" id="work_left">
                        <div id="owl-demo" class="owl-carousel owl-theme">
                            <div class="item"><img class="img-responsive img-rabbit" src="${base}/project-myself/images/work.jpg"></div>
                            <div class="item"><img class="img-responsive img-rabbit" src="${base}/project-myself/images/home.jpg"></div>
                            <div class="item"><img class="img-responsive img-rabbit" src="${base}/project-myself/images/contact.jpg"></div>
                        </div>
                    </div>
            ...
            <div class="container main">
                <div class="row">
                    <div class="col-md-6 left" id="contact_left">
                        <img class="img-responsive img-rabbit" src="${base}/project-myself/images/contact.jpg">
                    </div>
        ...
        <script src="${base}/project-myself/js/main.js"></script>
    </body>
</html>