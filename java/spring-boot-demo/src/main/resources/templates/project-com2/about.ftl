    ...
    <div class="layui-container">
      ...
      <div class="nav-list">
        ...
        <ul class="layui-nav" lay-filter="">
          ...
          <li class="layui-nav-item layui-this"><a href="/com2/about">关于</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="main-about">
    <div class="layui-container">
      <div class="layui-row">
        ...
        <div class="tabIntro">
          <div class="content">
            <div class="layui-inline img"><img src="/project-com2/img/us_img1.jpg"></div><div class="layui-inline panel">
          ...
          <div class="content">
            ...
            </div><div class="layui-inline img"><img src="/project-com2/img/us_img2.jpg"></div>
              <p class="p_hidden">如果眼下还是一团零星之火，那运筹帷幄之后，迎面东风，就是一场烈焰燎原吧，那必定会是一番尽情的燃烧。待，秋风萧瑟时，散作满天星辰，你看那四季轮回，正是Layui不灭的执念。</p>
          </div>
          <div class="content">
            <div class="layui-inline img"><img src="/project-com2/img/us_img3.jpg"></div><div class="layui-inline panel">
        ...
        <div class="tabCour">
          ...
          <ul class="timeline">
            <li class="odd">
              <div class="cour-img"><img src="/project-com2/img/us_img4.png"></div>
            ...
            <li>
              <div class="cour-img"><img src="/project-com2/img/us_img5.png"></div>
            ...
            <li class="odd">
              <div class="cour-img"><img src="/project-com2/img/us_img6.png"></div>
              <div class="cour-panel layui-col-sm4 layui-col-lg5">
                <p class="label">2017 年 6 月</p>
                <p>我们成立了，来到了杭州西湖这个美丽的地方。</p>
              </div>
            ...
            <li>
              <div class="cour-img"><img src="/project-com2/img/us_img7.png"></div>
              <div class="cour-panel layui-col-sm4 layui-col-sm-offset8 layui-col-lg5 layui-col-lg-offset7">
                <p class="label">2017 年 6 月</p>
                <p>我们成立了，来到了杭州西湖这个美丽的地方。</p>
              </div>
            ...
            <li class="odd">
              <div class="cour-img"><img src="/project-com2/img/us_img8.png"></div>
            </li>
          </ul>
        </div>
      </div>
