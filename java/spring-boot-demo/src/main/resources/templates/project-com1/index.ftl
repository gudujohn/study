  ...
  <div class="header_box">
    <div class="header">  
      ...
      <div class="nav"  style="visibility: visible">
        <a href="/com1" class="active">首页</a>
        <a href="/com1/case">案例</a>
        <a href="/com1/service">服务</a>
        <a href="/com1/about">关于</a>
      </div> 
      <ul class="layui-nav header-down-nav">
        <li class="layui-nav-item"><a href="/com1" class="active">首页</a></li>
    ...
    <div class="content">
      ...
      <div class="layui-carousel imgbox"  id="test1">
        <div carousel-item  class="imgH">
          <div><img style="width: 100%" src="/project-com1/images/sy_banner1.jpg"></div>
          <div><img style="width: 100%" src="/project-com1/images/sy_banner1.jpg"></div>
        </div>
      </div>
      <div class="prod-show">
        <div class="layui-fluid">
          <div class="row layui-col-space12 layui-clear">
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
              <div class="img-txt">
                <img style="width: 100%;" src="/project-com1/images/sy_img1.jpg" alt="">
                <h3>食品包装</h3>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
              <div class="img-txt">
                <img style="width: 100%;" src="/project-com1/images/sy_img2.jpg" alt="">
                <h3>食品包装</h3>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
              <div class="img-txt">
                <img style="width: 100%;" src="/project-com1/images/sy_img3.jpg" alt="">
                <h3>食品包装</h3>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
              <div class="img-txt">
                <img style="width: 100%;" src="/project-com1/images/sy_img4.jpg" alt="">
                <h3>食品包装</h3>
              </div>
            </div>
          </div>
      ...
      <div class="prod-descr">
        <div class="layui-fluid">
          <div class="layui-row">
            <div class="item layui-clear">
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <img src="/project-com1/images/sy_img5.jpg" class="left-img">
              </div>
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <div class="text">
                  <h3>优秀包装设计美学</h3>
                  <p>本公司专门为您打造定制的商品包装。本公司专门为您打造定制的商品包装。</p>
                  <a href="/com1/details">查看更多 ></a>
                </div>
              </div>
              <div class="layui-col-xs12 layui-col-sm12 layui-col-md8 bot-img-box">
                <div class="bot-img">
                  <img src="/project-com1/images/sy_img6.jpg">
                </div>
              </div>
            </div>
          </div>
          <div class="layui-row">
            <div class="item layui-clear">
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <img src="/project-com1/images/sy_img7.jpg" class="left-img">
              </div>
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <div class="text">
                  <h3>上等材质制作包装</h3>
              ...
              <div class="layui-col-xs12 layui-col-sm12 layui-col-md8 bot-img-box">
                <div class="bot-img">
                  <img src="/project-com1/images/sy_img8.jpg">
                </div>
              </div>
            </div>
          </div>
          <div class="layui-row">
            <div class="item layui-clear">
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <img src="/project-com1/images/sy_img9.jpg" class="left-img">
              </div>
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                <div class="text">
                  <h3>高级设备流水制作</h3>
              ...
              <div class="layui-col-xs12 layui-col-sm12 layui-col-md8 bot-img-box">
                <div class="bot-img">
                  <img src="/project-com1/images/sy_img610.jpg">
                </div>
              </div>
            </div>
          </div>
